...
from deepcube.code.environments import env_utils
import socket
import gc
from deepcube.code.ml_utils import nnet_utils
from deepcube.code.ml_utils import search_utils
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3'


# --------solve
def getResults_temp(state):
    return {'moves': ['L_1', 'R_1', 'U_1', 'F_-1', 'R_-1', 'D_-1', 'L_1', 'F_-1', 'B_-1', 'R_1', 'D_-1', 'L_1', 'D_1', 'B_-1', 'R_1', 'B_-1', 'D_-1', 'B_-1', 'D_1', 'L_-1', 'U_-1', 'R_1', 'U_1', 'F_-1', 'U_-1', 'R_-1', 'L_1', 'D_-1', 'F_1', 'L_1', 'L_1', 'U_1', 'L_-1', 'D_1', 'L_1', 'U_-1', 'L_-1'], 'moves_rev': ['L_-1', 'R_-1', 'U_-1', 'F_1', 'R_1', 'D_1', 'L_-1', 'F_1', 'B_1', 'R_-1', 'D_1', 'L_-1', 'D_-1', 'B_1', 'R_-1', 'B_1', 'D_1', 'B_1', 'D_-1', 'L_1', 'U_1', 'R_-1', 'U_-1', 'F_1', 'U_1', 'R_1', 'L_-1', 'D_1', 'F_-1', 'L_-1', 'L_-1', 'U_-1', 'L_1', 'D_-1', 'L_-1', 'U_1', 'L_1'], 'solve_text': ['L', 'R', 'U', "F'", "R'", "D'", 'L', "F'", "B'", 'R', "D'", 'L', 'D', "B'", 'R', "B'", "D'", "B'", 'D', "L'", "U'", 'R', 'U', "F'", "U'", "R'", 'L', "D'", 'F', 'L', 'L', 'U', "L'", 'D', 'L', "U'", "L'"]}
...
def getResults(state):
    ...
    parser.add_argument('--model_loc', type=str, default=os.path.join(os.getcwd(), "deepcube/code/savedModels/cube3/1"), help="Location of model")
    parser.add_argument('--model_name', type=str, default="saved_model.pb", help="Which model to load")    # model.meta
    ...
    parser.add_argument('--use_gpu', type=int, default=0, help="1 if using GPU")
